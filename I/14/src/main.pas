...
BEGIN
    ...
    writeln('Результат метода простых итераций: ', simple_iterations(a, b, e, f_12_x):8:5);

    segments(a, b, e);
    writeln(#13#10, '2)', #13#10, formula_2, #13#10);
    writeln(#13#10, 'Результат метода деления пополам: ', half_divide(a, b, e, f_20):10:9);
    writeln('Результат метода простых итераций: ', simple_iterations(a, b, e, f_20_x):8:5);
