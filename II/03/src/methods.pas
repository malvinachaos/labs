...
INTERFACE
    ...
    FUNCTION simple_iterations(var log: text; const e: real; f: func): real;
    FUNCTION tangent(var log: text; const e: real; f: func): real;
    FUNCTION newton(var log: text; const e: real; f: func): real;
    PROCEDURE segments(var log: text; var e: real; var ch: byte);
