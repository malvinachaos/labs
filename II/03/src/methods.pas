...
PROCEDURE half_divide       (var log: text; const eps: byte; const a, b, e: real; f: func; var x1: real; var i: byte);
...
PROCEDURE newton            (var log: text; const eps: byte; const a, b, e: real; f: func; var x1: real; var i: byte);
